...
namespace LastNa
{
    public partial class Company : Form
    {
        ...
        {
            string templatePath = @"C:\Users\MAIDON DURAN\OneDrive\Desktop\LastNa\TemplateCompany.xlsx";
            string newFilePath = @"C:\Users\MAIDON DURAN\OneDrive\Desktop\LastNa\TemplateCompanyExported.xlsx";
            ...
            try
            {
                ...
                using (var workbook = new XLWorkbook(templatePath))
                {
                    ...
                    sign.Value = "Signature: Maidon Duran (Company)";
        ...
        private void BindData2()
        {
            try
            {
                ...
                {
                    string sqlQuery = "SELECT * FROM future_company.company";
